...
const Navbar = () => {
  ...
  return (
    ...
    <span className=' text-cyan-600 font-bold '>Kathmandu,Nepal</span>
      ...
      <div className={`bg-cyan-400 rounded-[20px] text-green-800 font-semibold  pl-[50px] pr-[50px] md:flex flex-col md:flex-row justify-evenly md:gap-[100px] gap-4 md:mr-[60px] mr-4 pt-8 pb-8 w-full md:w-auto ${isOpen ? 'flex' : 'hidden'} md:flex`}>
